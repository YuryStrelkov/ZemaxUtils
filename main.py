...
def build_and_run_task_from_settings_list():
    ...
    :return:
    """
    z_file_src = r"E:\Aist_T\ZemaxExec\ZemaxUtils\ZemaxSchemes\F_07g_04_Blenda_PI_Zern_Real.zmx"
    z_task_src = r"E:\Aist_T\ZemaxExec\ZemaxUtils\ZemaxScemesSettings\schemas.json"
    z_task_dir = r"E:\Aist_T\ZemaxExec\ZemaxUtils\TestTask"
